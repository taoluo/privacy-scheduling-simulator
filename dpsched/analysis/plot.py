...
def plot_delay_cdf(table, delay_lst_column, cdf_color_col, save_file_name, should_exclude_late_task,
    ...
    #     table_delay.loc[ table_delay['commit_time']<0,delay_lst_column  ] = 1*table_delay.loc[ table_delay['commit_time']<0,'task_timeout'  ]
    # table_delay = table_delay.loc[  (table_delay['N_or_T_'] < 500)]
